...
const Footer: React.FC = () => {
    return (
        <footer className="relative z-10 bg-void-900/40 backdrop-blur-2xl border-t border-white/5 pt-20 pb-10 px-4 sm:px-6 lg:px-8 mt-auto">
            <div className="max-w-7xl mx-auto flex flex-col space-y-16">
                    ...
                    <div className="flex flex-col max-w-sm gap-6">
                        <Link to="/" className="flex items-center space-x-3 group">
                            <img
                                src="/logo.png"
                                alt="Miyalix"
                                className="w-10 h-10 object-contain group-hover:scale-110 transition-transform duration-300 drop-shadow-[0_0_10px_rgba(168,85,247,0.5)]"
                            />
                        ...
                        <p className="text-slate-400 text-sm font-light leading-relaxed tracking-wide">
                            Architecting digital experiences with uncompromising power. Merging high performance with cutting-edge aesthetic standards.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-16 sm:grid-cols-3">
                        <div>
                            ...
                            <ul className="space-y-4 text-sm font-light text-slate-400">
                                <li><Link to="/about" className="hover:text-raiden-400 transition-colors duration-300">About Us</Link></li>
                                <li><Link to="/contact" className="hover:text-raiden-400 transition-colors duration-300">Contact</Link></li>
                            </ul>
                        </div>
                        <div>
                            <h3 className="text-white text-xs font-bold uppercase tracking-[0.2em] mb-6">Expertise</h3>
                            <ul className="space-y-4 text-sm font-light text-slate-400">
                                <li><Link to="/services" className="hover:text-raiden-400 transition-colors duration-300">Web Development</Link></li>
                                <li><Link to="/services" className="hover:text-raiden-400 transition-colors duration-300">Cloud Architecture</Link></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div className="border-t border-white/5 pt-10 flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0 text-xs font-light tracking-wider text-slate-500 uppercase">
                    ...
                    <div className="flex space-x-8">
                        <a href="#" className="text-slate-500 hover:text-raiden-400 transition-colors duration-300">
