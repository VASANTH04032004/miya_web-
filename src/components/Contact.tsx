          ...
          <form onSubmit={handleSubmit} className="space-y-8 relative z-10">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="relative group">
                <input
                  ...
                  className="w-full bg-navy-900/50 border border-white/10 rounded-2xl px-6 pt-8 pb-3 text-white placeholder-transparent focus:outline-none focus:border-yellow-400 focus:ring-1 focus:ring-yellow-400 transition-all duration-300 peer font-light tracking-wide disabled:opacity-50"
                  placeholder="Name"
                />
                <label
                  htmlFor="name"
            ...
            <div className="relative group">
              <textarea
                ...
                onChange={handleChange}
                disabled={status === 'sending'}
                className="w-full bg-navy-900/50 border border-white/10 rounded-2xl px-6 pt-8 pb-3 text-white placeholder-transparent focus:outline-none focus:border-yellow-400 focus:ring-1 focus:ring-yellow-400 transition-all duration-300 peer resize-none font-light tracking-wide disabled:opacity-50"
                placeholder="Message"
              ></textarea>
              <label
                htmlFor="message"
            ...
            <motion.button
              ...
              className="w-full py-5 rounded-full font-bold tracking-[0.2em] uppercase text-navy-900 bg-gradient-to-r from-yellow-300 to-amber-600 shadow-[0_0_15px_rgba(255,215,0,0.2)] hover:shadow-[0_0_25px_rgba(255,215,0,0.5)] transition-shadow duration-300 relative overflow-hidden group mt-4 disabled:opacity-60 disabled:cursor-not-allowed"
            >
